              ...
              <table id="jadwal_periksa" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="index_dokter.php?page=tambah_jadwal_periksa&id=<?=$row['id'];?>" class="btn btn-success" role="button" title="Ubah Data">TAMBAH<i class="glyphicon glyphicon-tambah"></i></a>
